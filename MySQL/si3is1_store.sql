...
CREATE TABLE `turnover` (
  `id_turnover` int(11) NOT NULL AUTO_INCREMENT,
  `id_store` int(11) NOT NULL,
  `date` date NOT NULL,
  `amount` float NOT NULL,
  `profit` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_turnover`),
  UNIQUE KEY `id_store_date_turnover_uq` (`id_store`,`date`),
  KEY `fk_id_store_turnover_idx` (`id_store`),
  KEY `date_turnover_idx` (`date`),
  CONSTRAINT `fk_id_store_turnover` FOREIGN KEY (`id_store`) REFERENCES `store` (`id_store`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `turnover` VALUES (1,2,'2018-01-27',3.5,173.36),(2,1,'2018-01-27',0,0.00);
